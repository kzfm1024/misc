...
CParticle::CParticle()
{
	pointSize = getNormalRandom(5.0, 1.0);//(1.0, 0.5);
...
void CParticle::update(float t, float dt)
{
	...
	vVelocity += accel * dt;
	if(vPosition.y < heightT + 0.5) 
	{
		vPosition.y = heightT + 0.5;
...
{
	float t1 = 1.0, t2 = 2.0, t3 = 3.0;
  float red, green, blue;
	float t0 = t - createTime;
	/*
//	float t1 = 0.8, t2 = 1.5, t3 = 2.5;
	if(t0 < t1) {red = 1.0; green = 1.0; blue = 0.9; alpha = 0.3;}
	else if(t0 < t2) {red = 1.0; green = 0.8; blue = 0.1; alpha = 0.5;}
	else  { red = 0.9; green = 0.2; blue = 0.1; alpha = 0.7;}
//	else {red = 0.4; green = 0.4; blue = 0.38; alpha = 1.0;}
*/
	if(t0 < t1)      {red = 1.0; green = 1.0; blue = 0.2; }
	else if(t0 < t2) {red = 1.0; green = 0.5; blue = 0.1; }
	else             {red = 1.0; green = 0.1; blue = 0.0;}
