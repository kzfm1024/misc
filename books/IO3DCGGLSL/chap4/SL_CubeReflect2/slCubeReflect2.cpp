...
//光源
float lightPos[] = {0.0, 5.0, 5.0, 1.0};//光源位置
float lightPos0[] = {0.0, 5.0, 5.0, 1.0};//光源位置(初期値)
...
View view = { 
  ...
  0.0, 1.5, 0.0,//cnt 
	...
	60.0, 0.1, 100.0//fovY,nearZ, farZ
};
View view0 = view;
...
int main(int argc, char** argv)
{
  ...
  //ウィンドウ作成
  glutCreateWindow("反射マッピング2(SL_CubeReflect2)");
  //ウィンドウのサイズ変更
  ...
  //初期設定
  init();
  initGlsl(&shaderProg, "cubeReflect2.vert", "cubeReflect2.frag");
