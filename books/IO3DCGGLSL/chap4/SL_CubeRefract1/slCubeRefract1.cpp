...
キューブマッピングによる屈折環境マッピング1
framebuffer objectを利用
OpenGL+GLSL
*/
#include <stdio.h>
//#include <windows.h>
...
//affine変換用変数
float pos[] = { 0.0, 1.2, 0.0 };  //object中心のxyz座標
float scale[] = { 1.0, 1.0, 0.1 };//大きさ(倍率)
...
int main(int argc, char** argv)
{
  ...
  //ウィンドウ作成
  glutCreateWindow("屈折マッピング1(SL_CubeRefract1)");
  //ウィンドウのサイズ変更
