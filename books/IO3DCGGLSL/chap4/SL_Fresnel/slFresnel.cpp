...
int fps = 0;
int actionMode = 0;
float transparency0 = 0.5;//透明度
float reflectivity0 = 0.5;//垂直反射率
float nRatio0 = 2.0;//相対屈折率
...
int main(int argc, char** argv)
{
  ...
  //ウィンドウ作成
  glutCreateWindow("フレネル効果(SL_Fresnel)");
  //ウィンドウのサイズ変更
  ...
  init();
	initFramebuffer();
  initGlsl(&shaderProg, "Fresnel.vert", "Fresnel.frag");
