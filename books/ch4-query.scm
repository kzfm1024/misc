...
;
; Gauche で動作させるために interaction-environment に変更
;
;(define (execute exp)
...
;
; Gauche では「モジュールの継承」で extend が存在するため
; extend の定義を使用している場所よりも前に変更
;
;(define (extend variable value frame)
;  (cons (make-binding variable value) frame))

